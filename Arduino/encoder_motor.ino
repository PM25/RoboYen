...
Arm::Arm(int SERVO_FREQ) {
  ...
  this->base_horizontal = new ServoMotor(&this->pwm, 0, 100, 5, 0, 180, 110, 460);
  ...
  this->webcam_horizontal = new ServoMotor(&this->pwm, 6, 105, 5, 0, 180, 90, 470);
  this->webcam_vertical = new ServoMotor(&this->pwm, 7, 60, 5, 0, 180, 90, 470);
}
