...
Arm::Arm(int SERVO_FREQ) {
  ...
  this->base_horizontal = new ServoMotor(&this->pwm, 0, 100, 3, 0, 180, 110, 460);
  this->arm_vertical1 = new ServoMotor(&this->pwm, 1, 0, 1, 0, 180, 180, 400);
  this->arm_vertical2 = new ServoMotor(&this->pwm, 2, 80, 1, 0, 180, 100, 460);
  ...
  this->gripper = new ServoMotor(&this->pwm, 5, 20, 10, 0, 90, 285, 420);
